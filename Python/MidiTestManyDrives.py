...
#FlopPianoSynthServer

"""

polyphonic up to # of drives (depends on how many drives are connected)


"""
#https://www.mfiles.co.uk/midi-traditional.htm
#https://www.pianostreet.com/piano-music/
...
def main() ->None:
    ...
    for msg in mido.MidiFile(test_midi_file).play():
            #handle the note_on / note_off - ignote all other messages for now
...
if __name__ == '__main__':
    ...
    #print((FloppyDrive.CrashMode.FLIP.value))
